...
<div id="carouselId" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item">
            <img src="{{asset('assets/img/Warung-Online-0-8715d89e2a640ffa.jpg')}}" class="img-fluid w-100" id="gambar_slider" alt="Second slide">
        </div>
    </div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-sm-9 mx-auto">
            <!--product -->
            <div class="product">
                <h4 class="mb-4"><b>Produk Terbaru Kami</h4>
