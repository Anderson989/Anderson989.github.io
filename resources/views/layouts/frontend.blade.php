    ...
    <body>
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                      <h4>Tentang Kami</h4>
                        Amirashop Merupakan Toko Online Serba ada atau bisa disebut warung online, <br>
                        yang menjual berbagai kebutuhan sehari-hari. mulai dari pakaian, sembako, obat-obatan dan lainnya <br><br>
                    </div>
                    <div class="col-sm-4">
                        <h4>Customer Care</h4>
        ...
        <div class="copyright">
            <div class="container text-center">
                ...
                <br>
                Amira Shop ~ Toko Online Sederhana</div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
